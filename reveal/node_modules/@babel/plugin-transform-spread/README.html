...
<html>
  <head>
    ...
    <title>@babel/plugin-transform-spread &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../_sources/reveal/node_modules/@babel/plugin-transform-spread/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
    ...
    <div class="article row">
        <div class="col pl-md-3 pl-lg-5 content-container">
            ...
            <div id="jb-print-docs-body" class="onlyprint">
                <h1>@babel/plugin-transform-spread</h1>
                <!-- Table of contents -->
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="babel-plugin-transform-spread">
<h1>&#64;babel/plugin-transform-spread<a class="headerlink" href="#babel-plugin-transform-spread" title="Permalink to this headline">#</a></h1>
<blockquote>
<div><p>Compile ES2015 spread to ES5</p>
</div></blockquote>
<p>See our website <a class="reference external" href="https://babeljs.io/docs/en/babel-plugin-transform-spread">&#64;babel/plugin-transform-spread</a> for more information.</p>
<section id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">#</a></h2>
<p>Using npm:</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>npm<span class="w"> </span>install<span class="w"> </span>--save-dev<span class="w"> </span>@babel/plugin-transform-spread
</pre></div>
</div>
<p>or using yarn:</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>yarn<span class="w"> </span>add<span class="w"> </span>@babel/plugin-transform-spread<span class="w"> </span>--dev
</pre></div>
</div>
</section>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/@babel/plugin-transform-spread"
        },
