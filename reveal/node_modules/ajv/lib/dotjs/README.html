...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../_sources/reveal/node_modules/ajv/lib/dotjs/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<p>Do NOT edit them directly, edit the templates and run <code class="docutils literal notranslate"><span class="pre">npm</span> <span class="pre">run</span> <span class="pre">build</span></code> from main ajv folder.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/ajv/lib/dotjs"
        },
