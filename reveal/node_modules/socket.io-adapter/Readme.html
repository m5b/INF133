...
<html>
  <head>
    ...
    <title>socket.io-adapter &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../_sources/reveal/node_modules/socket.io-adapter/Readme.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="socket-io-adapter">
<h1>socket.io-adapter<a class="headerlink" href="#socket-io-adapter" title="Permalink to this headline">#</a></h1>
<p>Default socket.io in-memory adapter class.</p>
<section id="how-to-use">
<h2>How to use<a class="headerlink" href="#how-to-use" title="Permalink to this headline">#</a></h2>
<p>This module is not intended for end-user usage, but can be used as an
interface to inherit from other adapters you might want to build.</p>
<p>As an example of an adapter that builds on top of this, please take a look
at <a class="reference external" href="https://github.com/learnboost/socket.io-redis">socket.io-redis</a>.</p>
</section>
<section id="license">
...
<p>MIT</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/socket.io-adapter"
        },
