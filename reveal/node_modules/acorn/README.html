...
<html>
  <head>
    ...
    <title>Acorn &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../_sources/reveal/node_modules/acorn/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-parser-class">
     The
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#existing-plugins">
   Existing plugins
  </a>
 </li>
</ul>
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="acorn">
<h1>Acorn<a class="headerlink" href="#acorn" title="Permalink to this headline">#</a></h1>
...
<a class="reference external" href="https://github.com/acornjs/acorn/blob/master/acorn/LICENSE">MIT license</a>.</p>
<p>You are welcome to
<a class="reference external" href="https://github.com/acornjs/acorn/issues">report bugs</a> or create pull
requests on <a class="reference external" href="https://github.com/acornjs/acorn">github</a>.</p>
</section>
<section id="installation">
<h2>Installation<a class="headerlink" href="#installation" title="Permalink to this headline">#</a></h2>
<p>The easiest way to install acorn is from <a class="reference external" href="https://www.npmjs.com/"><code class="docutils literal notranslate"><span class="pre">npm</span></code></a>:</p>
...
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>git<span class="w"> </span>clone<span class="w"> </span>https://github.com/acornjs/acorn.git
<span class="nb">cd</span><span class="w"> </span>acorn
...
<p><strong>parse</strong><code class="docutils literal notranslate"><span class="pre">(input,</span> <span class="pre">options)</span></code> is the main interface to the library. The
<code class="docutils literal notranslate"><span class="pre">input</span></code> parameter is a string, <code class="docutils literal notranslate"><span class="pre">options</span></code> must be an object setting
some of the options listed below. The return value will be an abstract
syntax tree object as specified by the <a class="reference external" href="https://github.com/estree/estree">ESTree
spec</a>.</p>
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">let</span><span class="w"> </span><span class="nx">acorn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn&quot;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">acorn</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s2">&quot;1 + 1&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="nx">ecmaVersion</span><span class="o">:</span><span class="w"> </span><span class="mf">2020</span><span class="p">}));</span>
</pre></div>
</div>
...
have a <code class="docutils literal notranslate"><span class="pre">pos</span></code> property that indicates the string offset at which the
...
object containing any of these fields (only <code class="docutils literal notranslate"><span class="pre">ecmaVersion</span></code> is
required):</p>
<ul>
<li><p><strong>ecmaVersion</strong>: Indicates the ECMAScript version to parse. Must be
either 3, 5, 6 (or 2015), 7 (2016), 8 (2017), 9 (2018), 10 (2019),
11 (2020), 12 (2021), 13 (2022), 14 (2023), or <code class="docutils literal notranslate"><span class="pre">&quot;latest&quot;</span></code> (the
...
either <code class="docutils literal notranslate"><span class="pre">&quot;script&quot;</span></code> or <code class="docutils literal notranslate"><span class="pre">&quot;module&quot;</span></code>. This influences global strict mode
and parsing of <code class="docutils literal notranslate"><span class="pre">import</span></code> and <code class="docutils literal notranslate"><span class="pre">export</span></code> declarations.</p>
<p><strong>NOTE</strong>: If set to <code class="docutils literal notranslate"><span class="pre">&quot;module&quot;</span></code>, then static <code class="docutils literal notranslate"><span class="pre">import</span></code> / <code class="docutils literal notranslate"><span class="pre">export</span></code> syntax
will be valid, even if <code class="docutils literal notranslate"><span class="pre">ecmaVersion</span></code> is less than 6.</p>
</li>
...
option to <code class="docutils literal notranslate"><span class="pre">true</span></code> allows them anywhere where a statement is allowed,
and also allows <code class="docutils literal notranslate"><span class="pre">import.meta</span></code> expressions to appear in scripts
(when <code class="docutils literal notranslate"><span class="pre">sourceType</span></code> is not <code class="docutils literal notranslate"><span class="pre">&quot;module&quot;</span></code>).</p></li>
<li><p><strong>allowAwaitOutsideFunction</strong>: If <code class="docutils literal notranslate"><span class="pre">false</span></code>, <code class="docutils literal notranslate"><span class="pre">await</span></code> expressions can
only appear inside <code class="docutils literal notranslate"><span class="pre">async</span></code> functions. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code> in modules
for <code class="docutils literal notranslate"><span class="pre">ecmaVersion</span></code> 2022 and later, <code class="docutils literal notranslate"><span class="pre">false</span></code> for lower versions.
Setting this option to <code class="docutils literal notranslate"><span class="pre">true</span></code> allows to have top-level <code class="docutils literal notranslate"><span class="pre">await</span></code>
expressions. They are still not allowed in non-<code class="docutils literal notranslate"><span class="pre">async</span></code> functions,
though.</p></li>
<li><p><strong>allowSuperOutsideMethod</strong>: By default, <code class="docutils literal notranslate"><span class="pre">super</span></code> outside a method
raises an error. Set this to <code class="docutils literal notranslate"><span class="pre">true</span></code> to accept such code.</p></li>
<li><p><strong>allowHashBang</strong>: When this is enabled, if the code starts with the
characters <code class="docutils literal notranslate"><span class="pre">#!</span></code> (as in a shellscript), the first line will be
treated as a comment. Defaults to true when <code class="docutils literal notranslate"><span class="pre">ecmaVersion</span></code> &gt;= 2023.</p></li>
<li><p><strong>checkPrivateFields</strong>: By default, the parser will verify that
private properties are only used in places where they are valid and
have been declared. Set this to false to turn such checks off.</p></li>
...
add a
<a class="reference external" href="https://bugzilla.mozilla.org/show_bug.cgi?id=745678">semi-standardized</a>
<code class="docutils literal notranslate"><span class="pre">range</span></code> property holding a <code class="docutils literal notranslate"><span class="pre">[start,</span> <span class="pre">end]</span></code> array with the same
numbers, set the <code class="docutils literal notranslate"><span class="pre">ranges</span></code> option to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p></li>
...
reasonable job, but you are advised to use <code class="docutils literal notranslate"><span class="pre">parse</span></code> with the <code class="docutils literal notranslate"><span class="pre">onToken</span></code>
...
<p><strong>getLineInfo</strong><code class="docutils literal notranslate"><span class="pre">(input,</span> <span class="pre">offset)</span></code> can be used to get a <code class="docutils literal notranslate"><span class="pre">{line,</span> <span class="pre">column}</span></code> object for a given program string and offset.</p>
<section id="the-parser-class">
<h3>The <code class="docutils literal notranslate"><span class="pre">Parser</span></code> class<a class="headerlink" href="#the-parser-class" title="Permalink to this headline">#</a></h3>
<p>Instances of the <strong><code class="docutils literal notranslate"><span class="pre">Parser</span></code></strong> class contain all the state and logic
that drives a parse. It has static methods <code class="docutils literal notranslate"><span class="pre">parse</span></code>,
<code class="docutils literal notranslate"><span class="pre">parseExpressionAt</span></code>, and <code class="docutils literal notranslate"><span class="pre">tokenizer</span></code> that match the top-level
functions by the same name.</p>
<p>When extending the parser with plugins, you need to call these methods
on the extended version of the class. To extend a parser with plugins,
you can use its static <code class="docutils literal notranslate"><span class="pre">extend</span></code> method.</p>
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span><span class="w"> </span><span class="nx">acorn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn&quot;</span><span class="p">);</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">jsx</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn-jsx&quot;</span><span class="p">);</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">JSXParser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">acorn</span><span class="p">.</span><span class="nx">Parser</span><span class="p">.</span><span class="nx">extend</span><span class="p">(</span><span class="nx">jsx</span><span class="p">());</span>
<span class="nx">JSXParser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s2">&quot;foo(&lt;bar/&gt;)&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="nx">ecmaVersion</span><span class="o">:</span><span class="w"> </span><span class="mf">2020</span><span class="p">});</span>
</pre></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">extend</span></code> method takes any number of plugin values, and returns a
new <code class="docutils literal notranslate"><span class="pre">Parser</span></code> class that includes the extra parser logic provided by
the plugins.</p>
</section>
</section>
...
options:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">--ecma3|--ecma5|--ecma6|--ecma7|--ecma8|--ecma9|--ecma10</span></code>: Sets the ECMAScript version
to parse. Default is version 9.</p></li>
...
<li><p><code class="docutils literal notranslate"><span class="pre">--allow-hash-bang</span></code>: If the code starts with the characters #! (as
in a shellscript), the first line will be treated as a comment.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">--allow-await-outside-function</span></code>: Allows top-level <code class="docutils literal notranslate"><span class="pre">await</span></code> expressions.
See the <code class="docutils literal notranslate"><span class="pre">allowAwaitOutsideFunction</span></code> option for more information.</p></li>
