...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../_sources/reveal/node_modules/raw-body/node_modules/string_decoder/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
  ...
  <p><strong>string_decoder.js</strong> (<code class="docutils literal notranslate"><span class="pre">require('string_decoder')</span></code>) from Node.js core</p>
...
<p>The <em>build/</em> directory contains a build script that will scrape the source from the <a class="reference external" href="https://github.com/joyent/node">joyent/node</a> repo given a specific Node version.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/raw-body/node_modules/string_decoder"
        },
