...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../_sources/reveal/node_modules/engine.io/node_modules/ws/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#opt-in-for-performance">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#use-the-node-js-streams-api">
...
<a class="reference external" href="https://github.com/websockets/ws/actions?query=workflow%3ACI+branch%3Amaster"><img alt="CI" src="https://img.shields.io/github/workflow/status/websockets/ws/CI/master?label=CI&amp;logo=github" /></a>
...
<ul>
<li><p><a class="reference external" href="#opt-in-for-performance">Opt-in for performance</a></p></li>
</ul>
</li>
...
<li><p><a class="reference external" href="#client-authentication">Client authentication</a></p></li>
...
<li><p><a class="reference external" href="#use-the-nodejs-streams-api">Use the Node.js streams API</a></p></li>
...
<h3>Opt-in for performance<a class="headerlink" href="#opt-in-for-performance" title="Permalink to this headline">#</a></h3>
...
<p>See <span class="xref myst"><code class="docutils literal notranslate"><span class="pre">/doc/ws.md</span></code></span> for Node.js-like documentation of ws classes and
utility functions.</p>
</section>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">https</span><span class="p">.</span><span class="nx">createServer</span><span class="p">({</span>
...
<span class="w">  </span><span class="nx">ws</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;message&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">message</span><span class="p">(</span><span class="nx">msg</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="sb">`Received message </span><span class="si">${</span><span class="nx">msg</span><span class="si">}</span><span class="sb"> from user </span><span class="si">${</span><span class="nx">client</span><span class="si">}</span><span class="sb">`</span><span class="p">);</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">});</span>

<span class="nx">server</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;upgrade&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">upgrade</span><span class="p">(</span><span class="nx">request</span><span class="p">,</span><span class="w"> </span><span class="nx">socket</span><span class="p">,</span><span class="w"> </span><span class="nx">head</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// This function is not defined on purpose. Implement it with your own logic.</span>
<span class="w">  </span><span class="nx">authenticate</span><span class="p">(</span><span class="nx">request</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">,</span><span class="w"> </span><span class="nx">client</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
...
<p>Also see the provided <span class="xref myst">example</span> using <code class="docutils literal notranslate"><span class="pre">express-session</span></code>.</p>
</section>
...
<h3>Use the Node.js streams API<a class="headerlink" href="#use-the-node-js-streams-api" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">duplex</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">WebSocket</span><span class="p">.</span><span class="nx">createWebSocketStream</span><span class="p">(</span><span class="nx">ws</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">encoding</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;utf8&#39;</span><span class="w"> </span><span class="p">});</span>
...
<p><span class="xref myst">MIT</span></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/engine.io/node_modules/ws"
        },
