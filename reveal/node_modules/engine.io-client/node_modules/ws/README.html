...
<html>
  <head>
    ...
    <title>ws: a Node.js WebSocket library &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../../_sources/reveal/node_modules/engine.io-client/node_modules/ws/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#protocol-support">
   Protocol support
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#opt-in-for-performance-and-spec-compliance">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#websocket-compression">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#sending-and-receiving-text-data">
     Sending and receiving text data
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#sending-binary-data">
     Sending binary data
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#simple-server">
     Simple server
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#external-http-s-server">
     External HTTP/S server
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#multiple-servers-sharing-a-single-http-s-server">
     Multiple servers sharing a single HTTP/S server
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#server-broadcast">
     Server broadcast
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#echo-websocket-org-demo">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#error-handling-best-practices">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#how-to-get-the-ip-address-of-the-client">
     How to get the IP address of the client?
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#how-to-detect-and-close-broken-connections">
     How to detect and close broken connections?
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#how-to-connect-via-a-proxy">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="ws-a-node-js-websocket-library">
<h1>ws: a Node.js WebSocket library<a class="headerlink" href="#ws-a-node-js-websocket-library" title="Permalink to this headline">#</a></h1>
<p><a class="reference external" href="https://www.npmjs.com/package/ws"><img alt="Version npm" src="https://img.shields.io/npm/v/ws.svg" /></a>
<a class="reference external" href="https://travis-ci.org/websockets/ws"><img alt="Linux Build" src="https://img.shields.io/travis/websockets/ws/master.svg" /></a>
<a class="reference external" href="https://ci.appveyor.com/project/lpinca/ws"><img alt="Windows Build" src="https://ci.appveyor.com/api/projects/status/github/websockets/ws?branch=master&amp;svg=true" /></a>
<a class="reference external" href="https://coveralls.io/r/websockets/ws?branch=master"><img alt="Coverage Status" src="https://img.shields.io/coveralls/websockets/ws/master.svg" /></a></p>
...
<ul class="simple">
<li><p><a class="reference external" href="#protocol-support">Protocol support</a></p></li>
<li><p><a class="reference external" href="#installing">Installing</a></p>
<ul>
<li><p><a class="reference external" href="#opt-in-for-performance-and-spec-compliance">Opt-in for performance and spec compliance</a></p></li>
</ul>
</li>
<li><p><a class="reference external" href="#api-docs">API docs</a></p></li>
<li><p><a class="reference external" href="#websocket-compression">WebSocket compression</a></p></li>
<li><p><a class="reference external" href="#usage-examples">Usage examples</a></p>
<ul>
<li><p><a class="reference external" href="#sending-and-receiving-text-data">Sending and receiving text data</a></p></li>
<li><p><a class="reference external" href="#sending-binary-data">Sending binary data</a></p></li>
<li><p><a class="reference external" href="#simple-server">Simple server</a></p></li>
<li><p><a class="reference external" href="#external-https-server">External HTTP/S server</a></p></li>
<li><p><a class="reference external" href="#multiple-servers-sharing-a-single-https-server">Multiple servers sharing a single HTTP/S server</a></p></li>
<li><p><a class="reference external" href="#server-broadcast">Server broadcast</a></p></li>
<li><p><a class="reference external" href="#echowebsocketorg-demo">echo.websocket.org demo</a></p></li>
<li><p><a class="reference external" href="#other-examples">Other examples</a></p></li>
</ul>
</li>
<li><p><a class="reference external" href="#error-handling-best-practices">Error handling best practices</a></p></li>
<li><p><a class="reference external" href="#faq">FAQ</a></p>
<ul>
<li><p><a class="reference external" href="#how-to-get-the-ip-address-of-the-client">How to get the IP address of the client?</a></p></li>
<li><p><a class="reference external" href="#how-to-detect-and-close-broken-connections">How to detect and close broken connections?</a></p></li>
<li><p><a class="reference external" href="#how-to-connect-via-a-proxy">How to connect via a proxy?</a></p></li>
</ul>
</li>
...
<h3>Opt-in for performance and spec compliance<a class="headerlink" href="#opt-in-for-performance-and-spec-compliance" title="Permalink to this headline">#</a></h3>
...
message contains valid UTF-8 as required by the spec.</p></li>
</ul>
</section>
</section>
<section id="api-docs">
<h2>API docs<a class="headerlink" href="#api-docs" title="Permalink to this headline">#</a></h2>
<p>See <span class="xref myst"><code class="docutils literal notranslate"><span class="pre">/doc/ws.md</span></code></span> for Node.js-like docs for the ws classes.</p>
</section>
<section id="websocket-compression">
<h2>WebSocket compression<a class="headerlink" href="#websocket-compression" title="Permalink to this headline">#</a></h2>
...
<p>See <a class="reference external" href="https://github.com/websockets/ws/blob/master/doc/ws.md#new-websocketserveroptions-callback">the docs</a> for more options.</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">wss</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">WebSocket</span><span class="p">.</span><span class="nx">Server</span><span class="p">({</span>
...
<span class="w">    </span><span class="c1">// should not be compressed.</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">});</span>
</pre></div>
</div>
...
<h3>Sending and receiving text data<a class="headerlink" href="#sending-and-receiving-text-data" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<h3>Sending binary data<a class="headerlink" href="#sending-binary-data" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<h3>Simple server<a class="headerlink" href="#simple-server" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;received: %s&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">message</span><span class="p">);</span>
<span class="w">  </span><span class="p">});</span>
...
<h3>External HTTP/S server<a class="headerlink" href="#external-http-s-server" title="Permalink to this headline">#</a></h3>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">https</span><span class="p">.</span><span class="nx">createServer</span><span class="p">({</span>
<span class="w">  </span><span class="nx">cert</span><span class="o">:</span><span class="w"> </span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;/path/to/cert.pem&#39;</span><span class="p">),</span>
<span class="w">  </span><span class="nx">key</span><span class="o">:</span><span class="w"> </span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;/path/to/key.pem&#39;</span><span class="p">)</span>
<span class="p">});</span>
...
<h3>Multiple servers sharing a single HTTP/S server<a class="headerlink" href="#multiple-servers-sharing-a-single-http-s-server" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<h3>Server broadcast<a class="headerlink" href="#server-broadcast" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">wss</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">WebSocket</span><span class="p">.</span><span class="nx">Server</span><span class="p">({</span><span class="w"> </span><span class="nx">port</span><span class="o">:</span><span class="w"> </span><span class="mf">8080</span><span class="w"> </span><span class="p">});</span>

<span class="c1">// Broadcast to all.</span>
<span class="nx">wss</span><span class="p">.</span><span class="nx">broadcast</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">broadcast</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="nx">client</span><span class="p">.</span><span class="nx">send</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">};</span>
...
<span class="nx">wss</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;connection&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">connection</span><span class="p">(</span><span class="nx">ws</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">ws</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;message&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">incoming</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// Broadcast to everyone else.</span>
<span class="w">    </span><span class="nx">wss</span><span class="p">.</span><span class="nx">clients</span><span class="p">.</span><span class="nx">forEach</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="nx">each</span><span class="p">(</span><span class="nx">client</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<h3>echo.websocket.org demo<a class="headerlink" href="#echo-websocket-org-demo" title="Permalink to this headline">#</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span><span class="w"> </span><span class="nx">WebSocket</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">ws</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">WebSocket</span><span class="p">(</span><span class="s1">&#39;wss://echo.websocket.org/&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">origin</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;https://websocket.org&#39;</span>
<span class="p">});</span>
...
<span class="nx">ws</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;message&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">incoming</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="sb">`Roundtrip time: </span><span class="si">${</span><span class="nb">Date</span><span class="p">.</span><span class="nx">now</span><span class="p">()</span><span class="w"> </span><span class="o">-</span><span class="w"> </span><span class="nx">data</span><span class="si">}</span><span class="sb"> ms`</span><span class="p">);</span>
...
<h2>Error handling best practices<a class="headerlink" href="#error-handling-best-practices" title="Permalink to this headline">#</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="c1">// If the WebSocket is closed before the following send is attempted</span>
...
<span class="nx">ws</span><span class="p">.</span><span class="nx">send</span><span class="p">(</span><span class="s1">&#39;something&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="nx">ack</span><span class="p">(</span><span class="nx">error</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// If error is not defined, the send has been completed, otherwise the error</span>
<span class="w">  </span><span class="c1">// object will indicate what failed.</span>
<span class="p">});</span>
...
<h3>How to get the IP address of the client?<a class="headerlink" href="#how-to-get-the-ip-address-of-the-client" title="Permalink to this headline">#</a></h3>
...
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">ip</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">req</span><span class="p">.</span><span class="nx">connection</span><span class="p">.</span><span class="nx">remoteAddress</span><span class="p">;</span>
<span class="p">});</span>
</pre></div>
</div>
...
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">ip</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">[</span><span class="s1">&#39;x-forwarded-for&#39;</span><span class="p">].</span><span class="nx">split</span><span class="p">(</span><span class="sr">/\s*,\s*/</span><span class="p">)[</span><span class="mf">0</span><span class="p">];</span>
<span class="p">});</span>
</pre></div>
</div>
</section>
<section id="how-to-detect-and-close-broken-connections">
<h3>How to detect and close broken connections?<a class="headerlink" href="#how-to-detect-and-close-broken-connections" title="Permalink to this headline">#</a></h3>
...
<span class="kd">function</span><span class="w"> </span><span class="nx">noop</span><span class="p">()</span><span class="w"> </span><span class="p">{}</span>
...
<span class="w">    </span><span class="nx">ws</span><span class="p">.</span><span class="nx">ping</span><span class="p">(</span><span class="nx">noop</span><span class="p">);</span>
<span class="w">  </span><span class="p">});</span>
...
<span class="w">  </span><span class="c1">// Use `WebSocket#terminate()` and not `WebSocket#close()`. Delay should be</span>
<span class="w">  </span><span class="c1">// equal to the interval at which your server sends out pings plus a</span>
<span class="w">  </span><span class="c1">// conservative assumption of the latency.</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">client</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">WebSocket</span><span class="p">(</span><span class="s1">&#39;wss://echo.websocket.org/&#39;</span><span class="p">);</span>
...
<h3>How to connect via a proxy?<a class="headerlink" href="#how-to-connect-via-a-proxy" title="Permalink to this headline">#</a></h3>
...
<p><span class="xref myst">MIT</span></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/engine.io-client/node_modules/ws"
        },
