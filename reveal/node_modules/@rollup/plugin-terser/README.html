...
<html>
  <head>
    ...
    <title>@rollup/plugin-terser &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../_sources/reveal/node_modules/@rollup/plugin-terser/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#maxworkers">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <p><a class="reference external" href="https://www.npmjs.com/package/&#64;rollup/plugin-terser"><img alt="npm" src="https://img.shields.io/npm/v/&#64;rollup/plugin-terser" /></a>
<a class="reference external" href="https://packagephobia.now.sh/result?p=&#64;rollup/plugin-terser"><img alt="size" src="https://packagephobia.now.sh/badge?p=&#64;rollup/plugin-terser" /></a>
...
<section class="tex2jax_ignore mathjax_ignore" id="rollup-plugin-terser">
<h1>&#64;rollup/plugin-terser<a class="headerlink" href="#rollup-plugin-terser" title="Permalink to this headline">#</a></h1>
<p>🍣 A Rollup plugin to generate a minified bundle with terser.</p>
<section id="requirements">
<h2>Requirements<a class="headerlink" href="#requirements" title="Permalink to this headline">#</a></h2>
<p>This plugin requires an <a class="reference external" href="https://github.com/nodejs/Release">LTS</a> Node version (v14.0.0+) and Rollup v2.0+.</p>
</section>
<section id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">#</a></h2>
<p>Using npm:</p>
<div class="highlight-console notranslate"><div class="highlight"><pre><span></span><span class="go">npm install @rollup/plugin-terser --save-dev</span>
</pre></div>
</div>
</section>
<section id="usage">
...
<div class="highlight-typescript notranslate"><div class="highlight"><pre><span></span><span class="k">import</span><span class="w"> </span><span class="nx">terser</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@rollup/plugin-terser&#39;</span><span class="p">;</span>
...
<span class="w">  </span><span class="nx">plugins</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="nx">terser</span><span class="p">()]</span>
<span class="p">};</span>
</pre></div>
</div>
...
<p>The plugin accepts a terser <a class="reference external" href="https://github.com/terser/terser#minify-options">Options</a> object as input parameter,
to modify the default behaviour.</p>
<p>In addition to the <code class="docutils literal notranslate"><span class="pre">terser</span></code> options, it is also possible to provide the following options:</p>
<section id="maxworkers">
<h3><code class="docutils literal notranslate"><span class="pre">maxWorkers</span></code><a class="headerlink" href="#maxworkers" title="Permalink to this headline">#</a></h3>
...
<p>Instructs the plugin to use a specific amount of cpu threads.</p>
<div class="highlight-typescript notranslate"><div class="highlight"><pre><span></span><span class="k">import</span><span class="w"> </span><span class="nx">terser</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@rollup/plugin-terser&#39;</span><span class="p">;</span>
...
<span class="w">    </span><span class="nx">terser</span><span class="p">({</span>
<span class="w">      </span><span class="nx">maxWorkers</span><span class="o">:</span><span class="w"> </span><span class="kt">4</span>
<span class="w">    </span><span class="p">})</span>
<span class="w">  </span><span class="p">]</span>
<span class="p">};</span>
</pre></div>
...
<p><span class="xref myst">LICENSE (MIT)</span></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/@rollup/plugin-terser"
        },
