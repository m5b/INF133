...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../_sources/reveal/node_modules/core-js/stable/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
  ...
  <p>This folder contains entry points for all stable <code class="docutils literal notranslate"><span class="pre">core-js</span></code> features with dependencies. It’s the recommended way for usage only required features.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/core-js/stable"
        },
