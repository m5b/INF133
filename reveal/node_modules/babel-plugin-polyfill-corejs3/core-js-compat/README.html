...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../../_sources/reveal/node_modules/babel-plugin-polyfill-corejs3/core-js-compat/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
  ...
  <p><code class="docutils literal notranslate"><span class="pre">core-js-compat</span></code> exposes some files as JSON, and they cannot be
imported by Node.js ESM files.
This folder proxies <code class="docutils literal notranslate"><span class="pre">core-js-compat</span></code> to ensure that every entry
is CJS and can be safely imported.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/babel-plugin-polyfill-corejs3/core-js-compat"
        },
