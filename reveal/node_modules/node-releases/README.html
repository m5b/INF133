...
<html>
  <head>
    ...
    <title>Node.js releases data &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../_sources/reveal/node_modules/node-releases/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="node-js-releases-data">
<h1>Node.js releases data<a class="headerlink" href="#node-js-releases-data" title="Permalink to this headline">#</a></h1>
<p>All data is located in <code class="docutils literal notranslate"><span class="pre">data</span></code> directory.</p>
<p><code class="docutils literal notranslate"><span class="pre">data/processed</span></code> contains <code class="docutils literal notranslate"><span class="pre">envs.json</span></code> with node.js releases data preprocessed to be used by <a class="reference external" href="https://github.com/ai/browserslist">Browserslist</a> and other projects. Each version in this file contains only necessary info: version, release date, LTS flag/name, and security flag.</p>
<p><code class="docutils literal notranslate"><span class="pre">data/release-schedule</span></code> contains <code class="docutils literal notranslate"><span class="pre">release-schedule.json</span></code> with node.js releases date and end of life date.</p>
<section id="installation">
<h2>Installation<a class="headerlink" href="#installation" title="Permalink to this headline">#</a></h2>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>npm<span class="w"> </span>install<span class="w"> </span>node-releases
</pre></div>
</div>
</section>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/node-releases"
        },
