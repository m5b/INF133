...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../_sources/reveal/node_modules/extglob/changelog.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<ul class="simple">
<li><p>Adds <a class="reference external" href="readme.md#capture">.capture</a> method for capturing matches, thanks to <a class="reference external" href="https://github.com/devongovett">devongovett</a></p></li>
</ul>
</section>
<section id="v1-0-0">
...
<p><strong>Added features</strong></p>
<ul class="simple">
<li><p>Adds a <code class="docutils literal notranslate"><span class="pre">.create</span></code> method to do what the main function did before v1.0.0</p></li>
</ul>
<p><strong>Other changes</strong></p>
<ul class="simple">
<li><p>adds <code class="docutils literal notranslate"><span class="pre">expand-brackets</span></code> parsers/compilers to handle nested brackets and extglobs</p></li>
<li><p>uses <code class="docutils literal notranslate"><span class="pre">to-regex</span></code> to build regex for <code class="docutils literal notranslate"><span class="pre">makeRe</span></code> method</p></li>
<li><p>improves coverage</p></li>
<li><p>optimizations</p></li>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/extglob"
        },
