...
<html>
  <head>
    ...
    <title>whatwg-url &#8212; INF 133 Fall 2023</title>
...
<div class="menu-dropdown menu-dropdown-download-buttons">
  ...
  <div class="menu-dropdown__content">
    <ul>
      <li>
        <a href="../../../_sources/reveal/node_modules/whatwg-url/README.md"
   class="headerbtn"
   data-toggle="tooltip"
data-placement="left"
...
<div class="col-md-3 bd-toc show noprint">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#the-url-constructor">
     The
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#low-level-url-standard-api">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="whatwg-url">
<h1>whatwg-url<a class="headerlink" href="#whatwg-url" title="Permalink to this headline">#</a></h1>
<p>whatwg-url is a full implementation of the WHATWG <a class="reference external" href="https://url.spec.whatwg.org/">URL Standard</a>. It can be used standalone, but it also exposes a lot of the internal algorithms that are useful for integrating a URL parser into a project like <a class="reference external" href="https://github.com/tmpvar/jsdom">jsdom</a>.</p>
<section id="current-status">
<h2>Current Status<a class="headerlink" href="#current-status" title="Permalink to this headline">#</a></h2>
<p>whatwg-url is currently up to date with the URL spec up to commit <a class="reference external" href="https://github.com/whatwg/url/commit/a622235308342c9adc7fc2fd1659ff059f7d5e2a">a62223</a>.</p>
</section>
<section id="api">
<h2>API<a class="headerlink" href="#api" title="Permalink to this headline">#</a></h2>
<section id="the-url-constructor">
<h3>The <code class="docutils literal notranslate"><span class="pre">URL</span></code> Constructor<a class="headerlink" href="#the-url-constructor" title="Permalink to this headline">#</a></h3>
<p>The main API is the <a class="reference external" href="https://url.spec.whatwg.org/#url"><code class="docutils literal notranslate"><span class="pre">URL</span></code></a> export, which follows the spec’s behavior in all ways (including e.g. <code class="docutils literal notranslate"><span class="pre">USVString</span></code> conversion). Most consumers of this library will want to use this.</p>
</section>
<section id="low-level-url-standard-api">
<h3>Low-level URL Standard API<a class="headerlink" href="#low-level-url-standard-api" title="Permalink to this headline">#</a></h3>
<p>The following methods are exported for use by places like jsdom that need to implement things like <a class="reference external" href="https://html.spec.whatwg.org/#htmlhyperlinkelementutils"><code class="docutils literal notranslate"><span class="pre">HTMLHyperlinkElementUtils</span></code></a>. They operate on or return an “internal URL” or <a class="reference external" href="https://url.spec.whatwg.org/#concept-url">“URL record”</a> type.</p>
<ul class="simple">
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#concept-url-parser">URL parser</a>: <code class="docutils literal notranslate"><span class="pre">parseURL(input,</span> <span class="pre">{</span> <span class="pre">baseURL,</span> <span class="pre">encodingOverride</span> <span class="pre">})</span></code></p></li>
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#concept-basic-url-parser">Basic URL parser</a>: <code class="docutils literal notranslate"><span class="pre">basicURLParse(input,</span> <span class="pre">{</span> <span class="pre">baseURL,</span> <span class="pre">encodingOverride,</span> <span class="pre">url,</span> <span class="pre">stateOverride</span> <span class="pre">})</span></code></p></li>
...
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#concept-url-origin">Origin</a> <a class="reference external" href="https://html.spec.whatwg.org/multipage/browsers.html#serialization-of-an-origin">serializer</a>: <code class="docutils literal notranslate"><span class="pre">serializeURLOrigin(urlRecord)</span></code></p></li>
...
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#cannot-be-a-base-url-path-state"><code class="docutils literal notranslate"><span class="pre">&quot;cannot-be-a-base-URL</span> <span class="pre">path&quot;</span></code></a></p></li>
...
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#concept-url-path"><code class="docutils literal notranslate"><span class="pre">path</span></code></a> (as an array)</p></li>
...
<li><p><a class="reference external" href="https://url.spec.whatwg.org/#url-cannot-be-a-base-url-flag"><code class="docutils literal notranslate"><span class="pre">cannotBeABaseURL</span></code></a> (as a boolean)</p></li>
</ul>
...
<p>The return value of “failure” in the spec is represented by the string <code class="docutils literal notranslate"><span class="pre">&quot;failure&quot;</span></code>. That is, functions like <code class="docutils literal notranslate"><span class="pre">parseURL</span></code> and <code class="docutils literal notranslate"><span class="pre">basicURLParse</span></code> can return <em>either</em> a URL record <em>or</em> the string <code class="docutils literal notranslate"><span class="pre">&quot;failure&quot;</span></code>.</p>
</section>
</section>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./reveal/node_modules/whatwg-url"
        },
