...
```{attention}
This assignment is now a partnered project. If you would like to work as a pair with someone else in the class, feel free. We will cover how to handle partnered assignments in discussion class.
...
A [starter repository](https://classroom.github.com/a/8lyVCDCE) is on GitHub Classroom.
