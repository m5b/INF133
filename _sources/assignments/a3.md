...
A [starter repository](https://classroom.github.com/a/soP0sbse) is on GitHub Classroom.
...
NOTE: I've removed this clip to do its use of deprecated code. Please watch the Friday 2/10 recording for an updated overview on sendRequestToExpress.

```

##### Part 2: Spotify Browser Home Page (7 points)
...
###### Populating Information About the User (3 point)
...
###### Populating the Search Component (4 points)
...
##### Part 3: Spotify Browser Artist Page (5 points)
...
* Spotify Browser Home Page (7 points)
* Spotify Browser Artist Page (5 points)
