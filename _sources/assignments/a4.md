...
Once you have cloned the starter repository, you will need to create a new Ionic application. Feel free to store this app where ever you like, but if you are working with a partner you will probably want to continue to use the Github Classroom repository. So **`cd`** into the **`sleeptracker`** directory within **`a4-sleeptracker`** before generating a new project. Once you have decided on a location for this assignment you will create a new Ionic project from scratch by running:
