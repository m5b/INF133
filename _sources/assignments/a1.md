...
```{note}
It appears that ICS no longer offers this service. However, GitHub Pages is a great place to host a static website. [Learn more at the GitHub Pages website](https://pages.github.com/).
```
