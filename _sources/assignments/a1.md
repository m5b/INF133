...
A [starter repository](https://classroom.github.com/a/TleLV_Px) is on GitHub Classroom.
...
3. The page must pass accessibility guidelines, validated by [AChecker](https://achecker.achecks.ca/checker/index.php) and/or [Wave](https://wave.webaim.org/) (submit the AChecker validation, but perhaps try Wave too).
